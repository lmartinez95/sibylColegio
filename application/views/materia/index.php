				...
				<tbody>
					<?php foreach ($results as $result) { ?>
						<tr>
							...
							<td><a class="btn btn-outline-success" href=<?php echo base_url()."index.php/materia/update/" . $result["matId"]; ?> data-toggle="tooltip" data-placement="top" title="Modificar"><i class="far fa-edit"></i></a> </td>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<?php echo validation_errors();
							echo form_open('materia/agregar'); ?>
